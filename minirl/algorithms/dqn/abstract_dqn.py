...
class AbstractDQN(Agent):
    def __init__(self, environment, policy, approximator_params: dict, approximator: TorchApproximator = TorchApproximator, batch_size=32, target_update_frequency=50,
        ...
        approximator_params_target = deepcopy(approximator_params)
        self._initialize_approximator(approximator, approximator_params, approximator_params_target)

        self._num_updates = 0
        self._clip_reward = clip_reward
        self._update_frequency = target_update_frequency
